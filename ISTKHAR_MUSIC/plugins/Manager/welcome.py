...
from ISTKHAR_MUSIC.mongo.welcomedb import is_on, set_state, bump, cool, auto_on

BG_PATH = "ISTKHAR_MUSIC/assets/ISTKHAR/welcome.png"
FALLBACK_PIC = "ISTKHAR_MUSIC/assets/upic.png"
FONT_PATH = "ISTKHAR_MUSIC/assets/ISTKHAR/Arimo.ttf"
...
def build_pic(av, fn, uid, un):
    ...
    # 'ISTKHAR_MUSIC/assets/ISTKHAR/welcome.png' file.
...
async def welcome(client, update: ChatMemberUpdated):
    ...
    try:
        ...
        for f in (avatar, img):
            if f and os.path.exists(f) and "ISTKHAR_MUSIC/assets" not in f:
                try:
                    os.remove(f)
                except:
                    pass
