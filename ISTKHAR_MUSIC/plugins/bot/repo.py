...
async def show_repo(_, msg):
    buttons = [
        ...
        [
            ...
            InlineKeyboardButton("💬 ꜱᴜᴘᴘᴏʀᴛ", url="https://t.me/KavyaBots")
        ],
        [
            InlineKeyboardButton("🛠️ ꜱᴜᴘᴘᴏʀᴛ ᴄʜᴀᴛ", url="https://t.me/Iamistkhar"),
            InlineKeyboardButton("🎵 ɢɪᴛʜᴜʙ", url="https://github.com/TEAM-ISTKHAR/IstkharMusic")
        ]
    ]
