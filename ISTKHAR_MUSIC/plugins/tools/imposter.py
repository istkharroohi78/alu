...
from ISTKHAR_MUSIC.mongo.pretenderdb import (
    impo_off, impo_on, check_pretender,
    add_userdata, get_userdata, usr_data
)
from ISTKHAR_MUSIC.utils.admin_filters import admin_filter
...
""".format(
    ...
    if msg != "":
        await message.reply_photo("https://files.catbox.moe/h9dan0.jpg", caption=msg)
