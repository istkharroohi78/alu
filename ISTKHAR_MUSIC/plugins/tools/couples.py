...
from ISTKHAR_MUSIC.core.dir import COUPLE_DIR
from ISTKHAR_MUSIC.mongo.couples_db import get_couple, save_couple


ASSETS = Path("ISTKHAR_MUSIC/assets")
...
async def generate_image(chat_id: int, uid1: int, uid2: int, date: str) -> str:
    base = Image.open(ASSETS / "ISTKHAR/couple.png").convert("RGBA")
